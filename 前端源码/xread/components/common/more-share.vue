<template>
	<uni-popup ref="popup" type="bottom">
		...
		<view class="flex align-center">
			...
			hover-class="bg-light" @tap="share(item)">
				<view class="iconfont text-white flex align-center justify-center font-lg rounded-circle"
				:class="item.icon + ' ' + item.color"
				style="height: 100rpx; width: 100rpx;"></view>
				<text class="font-sm mt-1 text-muted">{{item.name}}</text>
			</view>
		</view>
		<view class="text-center py-2 font-md border-top" hover-class="bg-light" @click="close">取消</view>
	</uni-popup>
</template>
