<template>
	<view>
		<view class="flex align-center justify-between px-2">
			...
			<view class="flex align-center font text-secondary animated"
			hover-class="jello" @click="onpenMore">
				更多 <text class="iconfont iconmore"></text>
			</view>
		</view>
