<template>
	<view>
		...
		<uni-list-item title="关于艾克斯阅读" @click="open('about')"></uni-list-item>
		
		<view v-if="loginStatus" class="py-2 px-3">
			<button class="bg-pink text-white" style="border-radius: 50rpx;border: 0;" type="primary"
